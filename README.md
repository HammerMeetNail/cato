...
At startup Cato also repairs cover data poisoned by earlier bugs: URLs pointing at the defunct `images.themediapedia.com` host are cleared, and exhausted jobs are re-fetched with corrected URLs.
